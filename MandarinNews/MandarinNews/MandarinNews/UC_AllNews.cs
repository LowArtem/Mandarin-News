    ...
    public partial class UC_AllNews : UserControl
    {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (Form1.searchText != "" && Form1.isOnlyTodaysNews)
                ...
                model.Responce(Form1.SortSetting, Form1.LanguageSetting, DateTime.UtcNow.Date, PAGE_SIZE, page);
                ...
                model.Responce(Form1.LanguageSetting, Form1.SortSetting, PAGE_SIZE, page);
            else
                model.Responce(Form1.LanguageSetting, Form1.SortSetting, PAGE_SIZE, page);
